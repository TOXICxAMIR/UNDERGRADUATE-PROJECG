...
if(isset($_POST['insert']))
{
	...
	$query = "SELECT * FROM reservation where pid='$pid'";
	...
	if(!empty($name) && !empty($phone) && !empty($property_name))
	{
		
		$sql="INSERT INTO reservation (pid,uid,name,email,phone,property_name,location) VALUES ('$pid','$uid','$name','$email','$phone','$property_name','$location')";
		   $result=mysqli_query($con, $sql);
		   if($result){
			   $msg = "<p class='alert alert-success'>Property Reserved Successfully</p> ";
		   }
		   else{
			   $error = "<p class='alert alert-warning'>Property is already Registered</p> ";
		   }
	}else{
    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Reservation Page</b></h2>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Reservation</h2>
                        </div>
					</div>
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">Reservation Form</h5>
						<?php echo $msg; ?><?php echo $error; ?>
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                    <label for="user-id">PID</label>
                                    <input type="text" name="pid" class="form-control" placeholder="Enter Property ID">
                                </div> 
                                ...
                                <div class="form-group">
                                    <label for="user-id">Property Name</label>
