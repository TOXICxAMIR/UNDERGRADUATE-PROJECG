...
CREATE TABLE `vehicle` (
  ...
  `petrol capacity` int(50) NOT NULL,
  `diesel capacity` int(50) NOT NULL,
  `passengers capacity` int(50) NOT NULL,
  `Mileage covered` int(50) NOT NULL,
  ...
  `body type` varchar(300) NOT NULL,
  `doors` varchar(300) NOT NULL,
  `Country of Made` varchar(50) NOT NULL,
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
