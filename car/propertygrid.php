    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Filter Car</b></h2>
                    </div><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Filter Car</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT vehicle.*, user.uname FROM `vehicle`,`user` WHERE vehicle.uid=user.uid and type='{$type}' and stype='{$stype}' and city='{$city}'";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">DHS<?php echo $row['13'];?> <span class="text-white"><?php echo $row['12'];?> milimeter</span></div>
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>No Car Available</center></h1>";
								}
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Car</h4>
                            <ul class="property_list_widget">
							
								<?php 
								$query=mysqli_query($con,"SELECT * FROM `vehicle` ORDER BY date DESC LIMIT 6");
										while($row=mysqli_fetch_array($query))
										{
								?>
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                    <h6 class="text-secondary hover-text-success text-capitalize"><a href="cardetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h6>
