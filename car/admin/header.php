  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="../index.php" class="logo">
						<img src="assets/img/car.png" alt="Logo">
					</a>
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-map"></i> <span> Vehicle</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<!-- <li><a href="propertyadd.php"> Add Vehicle</a></li> -->
									<li><a href="propertyview.php"> View Vehicle </a></li>
									<li><a href="reservedprop.php"> Reserved Vehicle </a></li>
